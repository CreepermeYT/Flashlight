...
execute if score -dist flbc matches 51.. if entity @s[tag=flbc.oon] run loot spawn ~ ~ ~ loot flashlight_by_creepermeyt:high_damage
execute if score -dist flbc matches ..50 if entity @s[tag=flbc.oon] run loot spawn ~ ~ ~ loot flashlight_by_creepermeyt:low_damage
tag @e[type=item,nbt={Item:{tag:{display:{Name:'{"text":"flbc_damage"}'}}}}] add flbc.damage
execute if entity @s[tag=flbc.oon] if entity @e[tag=flbc.damage] run tag @s add flbc.damage
kill @e[type=item,tag=flbc.damage]

execute if entity @s[tag=!flbc.damage] run tag @s remove flbc.h1
...
execute if entity @s[tag=flbc.h2] run item modify entity @s weapon.offhand flashlight_by_creepermeyt:damagein2
execute if entity @s[tag=flbc.h3] run item modify entity @s weapon.offhand flashlight_by_creepermeyt:damagein3
execute if entity @s[tag=flbc.h4] run item modify entity @s weapon.offhand flashlight_by_creepermeyt:damagein4
execute if entity @s[tag=flbc.h5] run item modify entity @s weapon.offhand flashlight_by_creepermeyt:damagein5
